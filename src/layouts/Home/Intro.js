...
import introBackground from 'assets/face-678.mp4';
...
import notFoundVideo from 'assets/face-678.mp4';
import { ProjectBackground } from 'layouts/Project';
          ...
          <video
            ...
            <header className={styles.text}>
              <h1 className={styles.name} data-visible={visible} id={titleId}>
                <DecoderText text="Sudhanshu Samal" delay={300} />
              </h1>
